...
<body>
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table id="bookslist" class="table table-striped table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th><input type="checkbox" class="select-checkbox" id="multi-action-box" /></th>
                                                <th>Actions &nbsp; 
                                                    <button  class="btn btn-success btn-sm multi-activate-book multi-select" title="Change selected book status"><i class="btn-icon-only icon-check"> </i></button> 
                        ...
                        <div class="panel panel-success hidden" id="hiddenUpdateForm">
                            ...
                            <div class="panel-body">
                                <form role="form" id="UpdateBook" name="UpdateBook" action="../REST/manage-books.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <div class="controls">
                                            <input type="hidden" name="updateThisBook" id="updateThisBook" value="updateThisBook"/>
                                            <button type="submit" name="submitUpdateBook" id="submitUpdateBook" class="btn btn-danger">Update Book</button> &nbsp; &nbsp;
    ...
    <script src="assets/js/manage-books.js?<?php echo time(); ?>"></script>
